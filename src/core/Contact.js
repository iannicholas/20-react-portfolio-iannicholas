...
export default function Contact() {
  ...
  <div class="form-group" style={formInputs}>
  <label class="form-check-label" for="exampleFormControlTextArea1" ></label>
    <textarea type="text" class="form-control" id="exampleForomTextar" placeholder='Type message here'></textarea>
    
  </div>
  <br />
  <button type="submit" class="btn btn-primary" style={formButton}>Submit</button>
</form>
  );
}
